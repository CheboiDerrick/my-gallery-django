...
class TestImage(TestCase):
    def setUp(self):
        ...
        self.category.save_category()
        self.image_test = Image(id=1, name='Corrugated', description='This is a test description', location=self.location,
    ...
    def test_update_image(self):
        self.image_test.save_image()
        self.image_test.update_image(self.image_test.id, 'photo_gallery/test.jpg')
        changed_img = Image.objects.filter(image='photo_gallery/test.jpg')
        self.assertTrue(len(changed_img) > 0)